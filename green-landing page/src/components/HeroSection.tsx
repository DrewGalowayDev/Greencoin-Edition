...
export const HeroSection = () => {
  ...
  <Button 
    className="btn-glow px-8 py-4 text-lg font-dm-sans font-semibold group"
  ...
  <Button 
    variant="outline" 
    className="glass-card px-8 py-4 text-lg font-dm-sans border-glass-border hover:border-primary"
    onClick={() => window.open('https://drewgalowaydev.github.io/carbondocs/', '_blank')}
  >
    Learn More
  </Button>
</div>
